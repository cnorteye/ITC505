...
server.post('/submit', (req, res) => {
    ...
    if (!hero || !adjective1 || !pluralNoun1 || !place || !verbPast || !adjective2 || !pluralNoun2 || !verb || !exclamation || !noun) {
        res.status(400).send(`
            <html>
          <head>
              <link rel="stylesheet" type="text/css" href="/ITC505/lab-7-copy/styles.css">
          </head>
          <body>
            <h1>Submission Failed</h1>
            <p>Please fill out ALL fields</p>
            <a href="/ITC505/lab-7-copy/index.html" class="button">Go Back to Form</a>
          </body>
          </html>
        `);
        return;
    ...
    res.send(`
      ...
      <body>
        ...
        <a href="/ITC505/lab-7-copy/index.html" class="form__btn">Go Back to Form</a>
      </body>
      </html>
    `);
